    ...
    return (
        <div className="max-w-4xl mx-auto space-y-6 pb-12">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-3xl font-bold tracking-tight text-slate-800 dark:text-slate-100">My Profile</h1>
            ...
            <Card className="border-none shadow-xl shadow-slate-200/50 dark:shadow-none dark:border dark:border-slate-800 overflow-hidden bg-white dark:bg-slate-900">
                    ...
                    <div className="flex flex-col md:flex-row gap-8 items-start -mt-16">
                        ...
                        <div className="flex flex-col items-center space-y-4">
                            <div className="relative group">
                                <div className="absolute inset-0 bg-white dark:bg-slate-800 rounded-full scale-105 shadow-md" />
                                <img
                                    src={userForm.avatar || '/logo_placeholder.png'}
                                    alt="User Avatar"
                                    className="w-40 h-40 rounded-full object-cover border-4 border-white dark:border-slate-850 shadow-xl relative z-10"
                                />
                                <input
                                    type="file"
                                    ref={fileInputRef}
                        ...
                        <div className="flex-1 space-y-8 pt-20 md:pt-24 w-full">
                            <div className="grid md:grid-cols-2 gap-8">
                                <div className="space-y-2">
                                    <Label htmlFor="full-name" className="text-slate-600 dark:text-slate-400 font-semibold">Full Name</Label>
                                    <Input
                                        id="full-name"
                                        placeholder="Enter your name"
                                        value={userForm.name || ''}
                                        onChange={(e) => handleUserChange('name', e.target.value)}
                                        className="h-11 border-slate-200 dark:border-slate-700 focus:border-indigo-500 focus:ring-indigo-500 rounded-xl bg-transparent dark:text-slate-100"
                                    />
                                </div>
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        readOnly
                                        className="h-11 bg-slate-50 dark:bg-slate-800/50 border-slate-200 dark:border-slate-700 text-slate-500 dark:text-slate-400 rounded-xl cursor-not-allowed"
                                    />
                            ...
                            <div className="space-y-4 pt-4 border-t border-slate-100 dark:border-slate-800">
                                <Label htmlFor="password-reset" className="text-slate-600 dark:text-slate-400 font-semibold flex items-center gap-2">
                                    Account Password
                                    <Badge variant="outline" className="text-[10px] font-bold text-indigo-600 dark:text-indigo-400 border-indigo-100 dark:border-indigo-900/50 bg-indigo-50/50 dark:bg-indigo-950/20">Secure</Badge>
                                </Label>
                                <div className="relative group max-w-md">
                                    <Input
                                        ...
                                        className="h-12 border-slate-200 dark:border-slate-700 focus:border-indigo-500 focus:ring-indigo-500 rounded-xl font-mono tracking-widest pr-12 bg-transparent dark:text-slate-100"
                                    />
                                    <button
                                        type="button"
